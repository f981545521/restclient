...
public class RESTConst
{
    ...
    public static final String APIDOC = "接口文档";
    ...
    public static final String HTTP_REQUEST = "请求";

    public static final String HTTP_RESPONSE = "响应";

    public static final String HTTP_REQ_HEADER = "请求头";

    public static final String HTTP_REQ_BODY = "请求体";

    public static final String HTTP_REP_BODY = "响应体";
    ...
    public static final String RESPONSE = "响应";
    ...
    public static final String RESET_ALL = "重置 所有";

    public static final String RESET_REQ = "重置 请求";

    public static final String RESET_RSP = "重置 响应";

    public static final String START_TEST = "开始测试";

    public static final String STOP_TEST = "停止测试";

    public static final String TEST_REPORT = "测试报告";

    public static final String DISPLAY = "显示";

    public static final String EXIT = "退出";

    public static final String HIST = "历史";
    ...
    public static final String ABOUT_TOOL = "关于我";
